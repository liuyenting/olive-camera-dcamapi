cdef extern from 'lib/dcamapi4.h':
    ...
    enum DCAMDATA_REGIONTYPE:
        ...
        DCAMDATA_REGIONTYPE__ACCESSREADY		= 0x01000000, # DCAMDATA_ATTRIBUTE__ACCESSREADY
        DCAMDATA_REGIONTYPE__ACCESSBUSY			= 0x02000000, # DCAMDATA_ATTRIBUTE__ACCESSBUSY
        DCAMDATA_REGIONTYPE__HASVIEW			= 0x10000000, # DCAMDATA_ATTRIBUTE__HASVIEW

        DCAMDATA_REGIONTYPE__BODYMASK			= 0x00FFFFFF,
        DCAMDATA_REGIONTYPE__ATTRIBUTEMASK		= 0xFF000000, # DCAMDATA_ATTRIBUTE__MASK
